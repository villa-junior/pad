...
from sqlalchemy import Table, text, MetaData,insert, select

from app.database import SessionLocal,engine
from app.utils import gerar_cod_verificacao,enviar_email
...
def register():  # TODO: adicionar verificação de nome e matricula
    ...
    return render_template('2_auth/register.html')
...
def login():
    ...
    return render_template('2_auth/login.html')
...
def change_password():
    ...
    return render_template('2_auth/change_password.html')  
...
def verificar_email_endpoint():
    ...
    return render_template("2_auth/verify_email.html", email=email)
...
def recover_password():
    ...
    return render_template('2_auth/recover_password.html')
...
def reset_password():
    ...
    return render_template("2_auth/reset_password.html")
